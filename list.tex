...
\section{DP}
  ...
  \includecpp{LIS O(Nlog(N))}{./DP/LIS O(Nlog(N)).cpp}
...
\section{Geometry}
  \includecpp{Circle Intersect}{./Geometry/Circle Intersect.cpp}
  \includecpp{Closest Pair}{./Geometry/Closest Pair.cpp}
  \includecpp{Line}{./Geometry/Line.cpp}
  \includecpp{Max Min Enclosing Rectangle}{./Geometry/Max Min Enclosing Rectangle.cpp}
...
\section{Other}
  ...
  \includecpp{Quick sort}{./Other/Quick sort.cpp}
  \includecpp{Weighted Job Scheduling}{./Other/Weighted Job Scheduling.cpp}
  \includecpp{多區間算最大}{./Other/多區間算最大.cpp}
