...
\section{Geometry}
  \code{2D Point}{./Geometry/2D Point.cpp}
  \code{Circle Intersect}{./Geometry/Circle Intersect.cpp}
  \code{Circumcentre}{./Geometry/Circumcentre.cpp}
  \code{Closest Pair}{./Geometry/Closest Pair.cpp}
  \code{Line}{./Geometry/Line.cpp}
  \code{Max cover rectangle}{./Geometry/Max cover rectangle.cpp}
  \code{Polygon}{./Geometry/Polygon.cpp}
  \code{Smallest Circle}{./Geometry/Smallest Circle.cpp}
  \code{Triangle}{./Geometry/Triangle.cpp}
\section{Graph}
  \code{BCC edge}{./Graph/BCC edge.cpp}
  \code{BCC vertex}{./Graph/BCC vertex.cpp}
  ...
  \code{Hamilton cycle}{./Graph/Hamilton cycle.cpp}
  ...
  \code{Union find}{./Graph/Union find.cpp}
\section{Mathematics}
...
\section{Other}
  ...
  \code{N Queen problem}{./Other/N Queen problem.cpp}
